...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) dump.dll.pch et un fichier de type précompilé nommé StdAfx.obj.
